...
class Measure_Pro_model extends Base_Model
{
    public $table_name = 'measure_pro';
    public $primary_key = 'id';

    public function update_batch($data, $wig_id)
    {
        $this->db->from($this->table_name)->where(['measure_id' => $wig_id]);
    ...
    {
        $this->db->from($this->table_name)->where_in('id', implode(',', $aryId))->where(['measure_id' => $wig_id]);
